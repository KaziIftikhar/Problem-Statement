    ...
    public class SalariesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Salary != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Salary'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Dob,EmployeType,JoiningDate,Tsalary,Status")] Salary salary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Dob,EmployeType,JoiningDate,Tsalary,Status")] Salary salary)
        {
            if (id != salary.Id)
            {
                return NotFound();
